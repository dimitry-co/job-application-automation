...
function buildFormFillPrompt(applicationUrl: string): string {
  return [
    ...
    "If submit is visible, continue filling required fields on the current page but never click final submit.",
    "Stop when the next action would be clicking final submit.",
